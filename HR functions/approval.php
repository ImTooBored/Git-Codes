                        ...
                        <form method="GET" action="">
                            <div class="row mb-3">
                                ...
                                <select class="form-select bg-transparent border border-black text-black" id="type" name="type" required>
                                    <option value="p_client" <?php echo (isset($_GET['type']) && $_GET['type'] == 'p_client') ? 'selected' : ''; ?>>Company</option>
                                    <option value="p_employee" <?php echo (isset($_GET['type']) && $_GET['type'] == 'p_employee') ? 'selected' : ''; ?>>General Cleaning</option>
                                </select>
                                </div>
                                <div class="col-sm-6 col-md-3">
