                    ...
                    <form method="GET" action="">
                        <div class="row mb-3">
                            ...
                            <select class="form-select bg-transparent border border-black text-black" id="type" name="type" required>
                                <option value="p_client" <?php echo (isset($_GET['p_client']) && $_GET['p_client'] == 'p_client') ? 'selected' : ''; ?>>Potential client</option>
                                <option value="p_employee" <?php echo (isset($_GET['p_employee']) && $_GET['p_employee'] == 'p_employee') ? 'selected' : ''; ?>>Potential employee</option>
                            </select>
                            </div>
                            <div class="col-sm-6 col-md-3">
                            ...
                            <div class="table-responsive w-80">
                                <table class="table table-bordered table-striped text-center overflow-auto">
                                    ...
                                    <tbody>
                                        ...
                                        $type = isset($_GET['type']) ? $_GET['type'] : ''; // Variable for status filter
